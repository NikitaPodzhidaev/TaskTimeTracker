...
ИИ использовался для создания красивого
и читаемого README.md, и так же для создания удобной
Postman Collection, так как сам я использовал разные запросы и много, 
а с помощью ИИ это удобно в рамках демонстрации результата.

ИИ использовался для обсуждения вопросов по JWT-аутентификации,
так как в рамках данного задания это являлось наиболее сложной темой.
